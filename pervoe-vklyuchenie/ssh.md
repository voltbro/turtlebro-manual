...
Если подключение не происходит, вам необходимо определить IP адрес компьютера. Это возможно сделать подключившись к роутеру и найдя имя raspberry в списке подключенных устройств.
