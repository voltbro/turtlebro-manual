...
3. В файле .ros_params, расположенный в директории /home/pi робота TurtleBro, проверить значение переменной окружения [ROVER_WHEEL_PARAM](paket-turtlebro/params.md#nastroika-parametrov-v-faile-ros_params) для задания коэффициента вращения моторов. Для старых моторов параметр ROVER_WHEEL_PARAM должен равняться 22500, для новых моторов этот параметр должен быть равен 12280.
